...
CREATE UNIQUE INDEX "domains_org_id_name_unique" ON "domains" USING btree ("org_id","name");--> statement-breakpoint
CREATE INDEX "domains_name_idx" ON "domains" USING btree ("name");--> statement-breakpoint
CREATE INDEX "events_message_id_created_at_idx" ON "events" USING btree ("message_id","created_at");--> statement-breakpoint
CREATE INDEX "messages_org_id_idx" ON "messages" USING btree ("org_id");--> statement-breakpoint
CREATE INDEX "messages_domain_id_idx" ON "messages" USING btree ("domain_id");--> statement-breakpoint
