...
/**
 * WebhookConfiguredEndpoint Class Doc Comment
 *
 * @category Class
 * @package  PaperBoy\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class WebhookConfiguredEndpoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WebhookConfiguredEndpoint';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['signing_secret'] === null && !$this->isNullableSetToNull('signing_secret')) {
            $invalidProperties[] = "'signing_secret' is required";
        }
     ...
     * Sets signing_secret
     *
     * @param string|null $signing_secret Returned only on first creation and never by GET.
     *
     * @return self
     */
    public function setSigningSecret($signing_secret)
    {
        if (is_null($signing_secret)) {
            array_push($this->openAPINullablesSetToNull, 'signing_secret');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('signing_secret', $nullablesSetToNull);
            if ($index !== FALSE) {
