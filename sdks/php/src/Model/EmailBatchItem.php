...
/**
 * EmailBatchItem Class Doc Comment
 *
 * @category Class
 * @package  PaperBoy\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class EmailBatchItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EmailBatchItem';
     ...
     * Sets error
     *
     * @param array<string,mixed>|null $error error
     *
     * @return self
     */
