<?php
/**
 * OutboundProviderDomainOverrideInput
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * OutboundProviderDomainOverrideInput Class Doc Comment
 *
 * @category Class
 * @package  PaperBoy\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class OutboundProviderDomainOverrideInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OutboundProviderDomainOverrideInput';
     ...
     * Sets provider
     *
     * @param \PaperBoy\OpenApi\Model\OutboundProvider|null $provider provider
     *
     * @return self
     */
