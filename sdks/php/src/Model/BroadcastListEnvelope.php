...
/**
 * BroadcastListEnvelope Class Doc Comment
 *
 * @category Class
 * @package  PaperBoy\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class BroadcastListEnvelope implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BroadcastListEnvelope';
    ...
    protected static $openAPITypes = [
        'data' => '\PaperBoy\OpenApi\Model\Broadcast[]'
    ];
     ...
     * Gets data
     *
     * @return \PaperBoy\OpenApi\Model\Broadcast[]
     */
     ...
     * Sets data
     *
     * @param \PaperBoy\OpenApi\Model\Broadcast[] $data data
     *
     * @return self
     */
