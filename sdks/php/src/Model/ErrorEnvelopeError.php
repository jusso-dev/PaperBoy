...
/**
 * ErrorEnvelopeError Class Doc Comment
 *
 * @category Class
 * @package  PaperBoy\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class ErrorEnvelopeError implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ErrorEnvelope_error';
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'message' => 'string',
        'fields' => '\PaperBoy\OpenApi\Model\ValidationIssue[]',
        'environment' => 'string',
        'limit' => 'int',
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['retry_after_seconds']) && ($this->container['retry_after_seconds'] < 1)) {
     ...
     * Gets fields
     *
     * @return \PaperBoy\OpenApi\Model\ValidationIssue[]|null
     */
     ...
     * Sets fields
     *
     * @param \PaperBoy\OpenApi\Model\ValidationIssue[]|null $fields fields
     *
     * @return self
     */
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling ErrorEnvelopeError., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int|null $retry_after_seconds retry_after_seconds
     *
     * @return self
     */
    public function setRetryAfterSeconds($retry_after_seconds)
    {
        ...
        if (($retry_after_seconds < 1)) {
            throw new \InvalidArgumentException('invalid value for $retry_after_seconds when calling ErrorEnvelopeError., must be bigger than or equal to 1.');
        }
