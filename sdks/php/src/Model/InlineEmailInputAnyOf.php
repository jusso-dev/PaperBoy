...
/**
 * InlineEmailInputAnyOf Class Doc Comment
 *
 * @category Class
 * @package  PaperBoy\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class InlineEmailInputAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InlineEmailInput_anyOf';
    ...
    public function setHtml($html)
    {
        ...
        if ((mb_strlen($html) < 1)) {
            throw new \InvalidArgumentException('invalid length for $html when calling InlineEmailInputAnyOf., must be bigger than or equal to 1.');
        }
