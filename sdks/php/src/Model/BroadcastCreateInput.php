...
/**
 * BroadcastCreateInput Class Doc Comment
 *
 * @category Class
 * @package  PaperBoy\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class BroadcastCreateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BroadcastCreateInput';
     ...
     * Sets scheduled_for
     *
     * @param \DateTime|null $scheduled_for RFC 3339 UTC instant. PaperBoy serializes this with a trailing `Z`.
     *
     * @return self
     */
