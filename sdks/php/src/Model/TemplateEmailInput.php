...
/**
 * TemplateEmailInput Class Doc Comment
 *
 * @category Class
 * @package  PaperBoy\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class TemplateEmailInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TemplateEmailInput';
    ...
    public function setFrom($from)
    {
        ...
        if ((mb_strlen($from) > 320)) {
            throw new \InvalidArgumentException('invalid length for $from when calling TemplateEmailInput., must be smaller than or equal to 320.');
        }
        if ((mb_strlen($from) < 3)) {
            throw new \InvalidArgumentException('invalid length for $from when calling TemplateEmailInput., must be bigger than or equal to 3.');
        }
    ...
    public function setIdempotencyKey($idempotency_key)
    {
        ...
        if ((mb_strlen($idempotency_key) > 256)) {
            throw new \InvalidArgumentException('invalid length for $idempotency_key when calling TemplateEmailInput., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($idempotency_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $idempotency_key when calling TemplateEmailInput., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[!-~]+$/", ObjectSerializer::toString($idempotency_key)))) {
            throw new \InvalidArgumentException("invalid value for \$idempotency_key when calling TemplateEmailInput., must conform to the pattern /^[!-~]+$/.");
        }
    ...
    public function setTags($tags)
    {
        ...
        if ((count($tags) > 75)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling TemplateEmailInput., number of items must be less than or equal to 75.');
        }
