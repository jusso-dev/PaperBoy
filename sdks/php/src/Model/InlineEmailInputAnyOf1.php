...
/**
 * InlineEmailInputAnyOf1 Class Doc Comment
 *
 * @category Class
 * @package  PaperBoy\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class InlineEmailInputAnyOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InlineEmailInput_anyOf_1';
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling InlineEmailInputAnyOf1., must be bigger than or equal to 1.');
        }
