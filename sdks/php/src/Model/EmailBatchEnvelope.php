...
/**
 * EmailBatchEnvelope Class Doc Comment
 *
 * @category Class
 * @package  PaperBoy\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class EmailBatchEnvelope implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EmailBatchEnvelope';
    ...
    protected static $openAPITypes = [
        'data' => '\PaperBoy\OpenApi\Model\EmailBatchItem[]'
    ];
     ...
     * Gets data
     *
     * @return \PaperBoy\OpenApi\Model\EmailBatchItem[]
     */
     ...
     * Sets data
     *
     * @param \PaperBoy\OpenApi\Model\EmailBatchItem[] $data data
     *
     * @return self
     */
