...
class Template implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        return $this->container['required_variables'];
    }

    /**
     * Sets required_variables
     *
     * @param string[] $required_variables required_variables
     *
     * @return self
     */
    public function setRequiredVariables($required_variables)
    {
        if (is_null($required_variables)) {
